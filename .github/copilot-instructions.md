...
- Apple Wallet: APPLE_PASS_TYPE_ID, APPLE_TEAM_ID, APPLE_PASS_CERT_BASE64, APPLE_PASS_KEY_BASE64, APPLE_WWDR_CERT_BASE64 (see WALLET-SETUP.md).
- Google Wallet: GOOGLE_WALLET_ISSUER_ID, GOOGLE_WALLET_CLASS_ID, GOOGLE_SERVICE_ACCOUNT_EMAIL, GOOGLE_SERVICE_ACCOUNT_KEY_BASE64 (see WALLET-SETUP.md).
